...
class Jan31CameraClickIntent : AppCompatActivity() {
...
//    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_jan31_camera_click_intent)
    ...
    camera_open_id.setOnClickListener {
        ...
        val cameraIntent = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.CUPCAKE) {
